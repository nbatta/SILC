...
def get_atmosphere_C(freqs, version=1, el=None):
    ...
    if version == 0:
        ...
        data_bands = np.array([ 20., 27., 39., 93., 145., 222., 280., 348., 405., 850.])
...
class CcatLatv2(SOLatType):
    ...
    def __init__(self, sensitivity_mode=None,
        ...
        # Define the instrument.
        self.bands = np.array([
            20., 27., 39., 93., 145., 222., 280., 348., 405., 850.])
        # scaled beam for 410 GHz but need to check 350 and 410.
        self.beams = np.array([
            10., 7.4, 5.1, 2.2, 1.4, 57/60., 45/60., 35/60., 30/60., 14/60.])
        self.n_bands = len(self.bands)
        ...
        self.tube_configs = {
            ...
            'UHF': nar([   0,   0,   0,   0,   0,7.6,14.2,    0,    0, 0]),
            'XHF': nar([   0,   0,   0,   0,   0,   0,   0,54.1,192.2, 0]),
            'ZHF': nar([   0,   0,   0,   0,   0,   0,   0,    0,  0,296605.4]),
        }
